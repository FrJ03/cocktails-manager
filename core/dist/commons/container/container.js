...
const delete_cocktail_use_case_1 = require("../../cocktail/application/delete-cocktail.use-case");
...
const Container = {
    init: () => {
        ...
        return {
            ...
            deleteCocktail: new delete_cocktail_use_case_1.DeleteCocktailUseCase(cocktails)
        };
    }
};
